...
const FAQ = (props) => {
  return (
    <Banner>
      ...
      <Banner.Entity>
          <Banner.Question>How much personal information does inSite store?</Banner.Question>
          <Banner.Text>
      ...
      <Banner.Entity>
          <Banner.Question>Now that I am logged in to inSite, how do I log in to Reddit/Twitter/YouTube/Instagram?</Banner.Question>
          <Banner.Text>
      ...
      <Banner.Entity>
          <Banner.Question>I am logged into one or more social media accounts. How do I see more information about the account(s)?</Banner.Question>
          <Banner.Text>
      ...
      <Banner.Entity>
          <Banner.Question>How do I log out of a social media account through inSite?</Banner.Question>
          <Banner.Text>
